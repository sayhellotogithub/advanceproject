...
import com.iblogstreet.explore_ar.presentation.widget.ArSolarSystemSample
 ...
 */
@AndroidEntryPoint
class ExploreARSolarSystemScreen : AppCompatActivity() {
    companion object {
        @JvmStatic
        internal fun start(context: Context) {
            val intent = Intent(context, ExploreARSolarSystemScreen::class.java)
