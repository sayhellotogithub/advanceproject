...
class RegexUtil {
  static final String REGEX_NUMBER = r"^[0-9]*$";

  static bool isNumber(String? number) {
    return matches(REGEX_NUMBER, number);
  }
  ...
  static List<String> ID_CARD_PROVINCE_DICT = [
    '11=北京',
    '12=天津',
    '13=河北',
    '14=山西',
  ...
  static String? handleCountryCode(String? countryCode) {
