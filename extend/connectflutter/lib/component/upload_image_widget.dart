                          ...
                          child: Align(
                            child: Text(
                              AppLocalizations.of(context)!
                                  .click_upload_bank_card,
                              style: TextStyle(
                                  fontSize: 12, color: ColorUtil.colorFF445FF1),
                            ),
                          )),
                    if (!hasPicture())
                      Positioned(
                        ...
                        child: InkWell(
                          child: SvgPicture.asset(
                            ImageUtil.getIconString("icon_take_photo"),
                          ),
                          onTap: () async {
                    ...
                    child: InkWell(
                      child: Align(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 16, color: ColorUtil.color303030),
                        ),
                      ),
                      onTap: () {
                        pickFromCamera();
  ...
  Widget _buildDelete() {
    return InkWell(
      child: Container(
        ...
        child: SvgPicture.asset(
          ImageUtil.getIconString("icon_delete"),
        ),
      ),
      onTap: () {
        setState(() {
