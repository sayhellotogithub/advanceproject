...
class AzListView extends StatefulWidget {
  AzListView({
    ...
    this.leftContainerBodyPadding = const EdgeInsets.only(right: 10),
    this.leftContainerBodyWidth = 60,
    this.fixHeader = true,
  }) : super(key: key);
  ...
  final EdgeInsets leftContainerBodyPadding;
  final double leftContainerBodyWidth;
    ...
    return Stack(
      children: [
        SuspensionView(
          ...
          fixHeader: widget.fixHeader,
        ),
        Align(
          alignment: widget.indexBarAlignment,
          child: Container(
            width: widget.leftContainerBodyWidth,
            padding: widget.leftContainerBodyPadding,
