...
import 'package:flutter/material.dart';import 'package:flutter/physics.dart';
...
class _SlidingUpPanelState extends State<SlidingUpPanel>
  ...
  Widget _gestureHandler({required Widget child}) {
    ...
    return Listener(
      onPointerDown:
          (PointerDownEvent p) => _vt.addPosition(p.timeStamp, p.position),
